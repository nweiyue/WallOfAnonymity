...
// ----- week 11 challenge: drawing ------
//step 2:
let svgdiv = document.getElementById("svgcanvas");

//step 3:
var paper = new Raphael(svgdiv);
var rect1 = paper.rect(0,0,400,300).attr({"fill": "white"});

//step 4: 
var raphaelPath; // for holding raphael path 
var pathString; //for holding path string 
var mousePushed = false; //for remembering state of mouse 

// Step 11:
var clearButton = document.getElementById("clear");
clearButton.addEventListener("click", function(ev){
    paper.clear();
    paper.rect(0,0,400,300).attr({"fill": "white"});
